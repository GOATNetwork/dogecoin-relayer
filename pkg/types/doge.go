...
// DogeTestNetParams defines the network parameters for Dogecoin testnet.
// The upstream doged library's TestNet3Params uses Bitcoin testnet address prefixes (0x6f),
// but Dogecoin testnet uses 0x71 for P2PKH addresses.
var DogeTestNetParams = chaincfg.Params{
	Name:        "dogetestnet",
	Net:         wire.TestNet3,
	DefaultPort: "44556",

	// Chain parameters - use same as mainnet structure
	...
	// Address encoding magics - CRITICAL: Dogecoin testnet uses 0x71, not 0x6f
	PubKeyHashAddrID:        0x71, // Dogecoin testnet P2PKH addresses start with 'n'
	ScriptHashAddrID:        0xc4, // starts with 2
	PrivateKeyID:            0xf1, // Dogecoin testnet WIF starts with 9 or c
...
func GetDogeNetwork(networkType string) *chaincfg.Params {
	...
	case "testnet":
		// Use custom DogeTestNetParams with correct address prefix (0x71)
		// instead of chaincfg.TestNet3Params which uses Bitcoin's 0x6f
